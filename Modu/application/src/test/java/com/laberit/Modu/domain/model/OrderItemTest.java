...
class OrderItemTest {
    ...
    void getTotalPrice_shouldMultiplyUnitPriceByQuantity() {
        OrderItem item = OrderItem.builder().unitPrice(10.0).quantity(3).build();
    ...
    void getTotalPrice_shouldRoundHalfUp() {
        ...
        OrderItem item = OrderItem.builder().unitPrice(1.005).quantity(1).build();
    ...
    void getTotalPrice_shouldRoundDown() {
        ...
        OrderItem item = OrderItem.builder().unitPrice(1.004).quantity(1).build();
    ...
    void getTotalPrice_shouldAccumulateAcrossQuantity() {
        ...
        OrderItem item = OrderItem.builder().unitPrice(0.10).quantity(3).build();
